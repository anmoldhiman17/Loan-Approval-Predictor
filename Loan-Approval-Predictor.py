...
# Works with Kaggle file: train_u6lujuX_CVtuZ9i.csv
# ============================================
...
# ---------- 1) Load ----------
CSV_PATH = "Week 5 Project GNCIPL/archive (11).zip"  # <- yaha apni file ka naam/path de
...
# NOTE: 'Dependents' me '3+' jaise values aati hain.
# Hum ise categorical hi treat kar rahe hain, isliye convert karne ki zarurat nahi.
# OneHotEncoder handle kar lega.
